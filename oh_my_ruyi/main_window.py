...
from .controllers import ProvisionController, RepoController, VersionController
...
class ProvisionMainWindow(QMainWindow):
    ...
    def __init__(
        ...
        *,
        ...
        self.version_controller = VersionController(self)
    ...
    def _start_download(self) -> None:
        ...
        self.provision_controller.download_finished.connect(
            lambda success, msg: self._on_download_finished_controller(success, msg)
        )
    ...
    def _on_download_finished_controller(self, success: bool, message: str) -> None:
        ...
        self._set_status_kind(self._download_status, "success" if success else "error")
        if success:
            self._machine.download_ok = True
        self._refresh_buttons()
        if success and self._machine.auto_step:
            self._machine.next()
